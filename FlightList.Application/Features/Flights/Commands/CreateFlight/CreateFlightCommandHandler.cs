...
public class CreateFlightCommandHandler : IRequestHandler<CreateFlightCommad, string>
{
    private readonly IFlightRepository _flightRepository;
    private readonly IMapper _mapper;
    private readonly IAirportRepository _airportRepository;

    public CreateFlightCommandHandler(IFlightRepository flightRepository, IMapper mapper, IAirportRepository airportRepository)
    {
    ...
    public async Task<string> Handle(CreateFlightCommad request, CancellationToken cancellationToken)
    {
